...
class M_Customer extends CI_Model
{
    ...
    public function get_all_customer($id)
    {
        ...
        $sql = 'select *, CONCAT("' . $base . '", image) as image from t_customer where company_id=' . $id . '';
    ...
    {
        $base = $this->config->base_url() . 'uploads/rm/file/image/job/';
        $base_profile = $this->config->base_url() . 'uploads/rm/file/image/user_profile/';
    ...
    {
        $base = $this->config->base_url() . 'uploads/rm/file/image/user_profile/';
