            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($this->upload->do_upload('image')) {
                        ...
                        $sql = 'insert into t_customer (name, description, address, owner_name, phone, image, location, status, created_by, created_date, modified_by, modified_date) values ("' . $name . '", "' . $description . '", "' . $address . '", "' . $owner_name . '", "' . $phone . '", "' . $picture . '", "' . $location . '", "' . $status . '", "' . $created_by . '", "' . $created_date . '", "' . $modified_by . '", "' . $modified_date . '")';
